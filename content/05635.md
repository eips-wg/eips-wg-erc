...
Anyone can retrieve licensing royalty information with `licensingRoyalty` via the registry. While it is not possible to enforce the rules set out in this EIP on-chain, just like [EIP-2981](https://eips.fyi/2981), we encourages NFT marketplaces to follow this EIP.
...
This standard is compatible with [EIP-721](https://eips.fyi/721), [EIP-1155](https://eips.fyi/1155), and [EIP-2981](https://eips.fyi/2981).

## Reference Implementation

### Examples

#### Deploying an [EIP-721](https://eips.fyi/721) NFT and signaling support for dNFT
