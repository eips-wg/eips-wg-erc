...
The EIP is a Redeemable NFT extension which adds a `redeem` function to [EIP-721](https://eips.fyi/721). It can be implemented when an NFT issuer wants his/her NFT to be redeemed for a physical object.
