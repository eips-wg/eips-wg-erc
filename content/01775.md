...
These app keys can then be endowed a different set of permissions (through the requestPermission model introduced in [EIP-2255](https://eips.fyi/2255)). This will potentially allow an user to partly trust some apps to perform some crypto operations on their behalf without compromising any security with respect to her main accounts.

## Motivation
Wallets developers have agreed on an HD derivation path for ethereum accounts using BIP32, BIP44, SLIP44, [(see the discussion here)](https://github.com/ethereum/EIPs/issues/84). Web3 wallets have implemented in a roughly similar way the rpc eth api. [EIP-1102](https://eips.fyi/1102) introduced privacy through non automatic opt-in of a wallet account into an app increasing privacy.
...
[EIP1581: Non-wallet usage of keys derived from BIP32 trees](https://eips.fyi/1581)
...
* [SLIP44: Registered coin types for BIP44](https://github.com/satoshilabs/slips/blob/master/https://eips.fyi/0044)
...
* [EIP600 Ethereum purpose allocation for Deterministic Wallets](https://eips.fyi/600)


* [EIP601 Ethereum hierarchy for deterministic wallets](https://eips.fyi/601)
...
* [EIP1102: Opt-in account exposure](https://eips.fyi/1102)

* [EIP1581: Non-wallet usage of keys derived from BIP-32 trees](https://eips.fyi/1581)

* [EIP1581: discussion](https://ethereum-magicians.org/t/non-wallet-usage-of-keys-derived-from-bip-32-trees/1817/4)

* [SLIP13: Authentication using deterministic hierarchy](https://github.com/satoshilabs/slips/blob/master/https://eips.fyi/0013)
