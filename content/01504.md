...
Since the Upgrader contract in [ERC-1504](https://eips.fyi/1504) has a simple voting mechanism, it is prone to all the limitations that the voting contract is facing:
...
2. [ERC-1504](https://eips.fyi/1504) - a reference implementation
