...
An extension of the [ERC-721 standard](https://eips.fyi/721) to enable ERC-721 tokens to own other ERC-721 tokens and [ERC-20](https://eips.fyi/20) tokens.

An extension of the [ERC-20](https://eips.fyi/20) and `ERC-223 https://github.com/ethereum/EIPs/issues/223` standards to enable ERC-20 and `ERC-223` tokens to be owned by ERC-721 tokens.
...
`ERC998ERC721` top-down, `ERC998ERC20` top-down, and `ERC998ERC721` bottom-up composable contracts must implement the [ERC-721 interface](https://eips.fyi/721).

### ERC-20

`ERC998ERC20` bottom-up composable contracts must implement the [ERC-20 interface](https://eips.fyi/20).

### [ERC-165](https://eips.fyi/165)

The [ERC-165 standard](https://eips.fyi/165) must be applied to each [ERC-998](https://eips.fyi/998) interface that is used.
...
/// @dev See https://github.com/ethereum/EIPs/blob/master/EIPS/https://eips.fyi/998
