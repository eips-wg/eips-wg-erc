...
It is RECOMMENDED that EVM address strings adhere to [ERC-1191](https://eips.fyi/1191) so that the browser client can checksum the validity of the address and its target network before making an RPC call. 
