...
They can be implemented using a modified version of [EIP-1820](https://eips.fyi/1820#erc-1820-registry-smart-contract) that allows [EIP-173](https://eips.fyi/173) contract owners to call `setManager()`.
...
Interactive NFTs are likely to update their metadata in response to certain actions and developers MAY want to implement [EIP-4906](https://eips.fyi/4906) event emitters.
