...
This standard is an improvement of [EIP-1538](https://eips.fyi/1538). The same motivations of that standard apply to this standard.
...
1. Because diamonds do not have a max size limitation it is possible to add gas optimizing functions for use cases. For example someone could use a diamond to implement the [EIP-721](https://eips.fyi/721) standard and implement batch transfer functions to reduce gas (and make batch transfers more convenient).
