...
[ERC-721](https://eips.fyi/721) and [ERC-1155](https://eips.fyi/1155), the ordering information of 
multiple NFTs is discarded. However, as proposed in [EIP-3754](https://eips.fyi/3754), 
...
language. This illustrates the key difference between this standard and [ERC-1155](https://eips.fyi/1155).
...
## Rationale
In [ERC-1155](https://eips.fyi/1155) and [ERC-721](https://eips.fyi/721), NFTs are used to represent
crypto-assets, and in this standard together with [EIP-3754](https://eips.fyi/3754), NFTs
...
is kept in storage and hence additional storage than [ERC-1155](https://eips.fyi/1155) is required.

## Backwards Compatibility
[EIP-3754](https://eips.fyi/3754) is the pre-requisite to this standard.
