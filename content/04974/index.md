...
This standard is influenced by the [EIP-20](https://eips.fyi/20) and [EIP-721](https://eips.fyi/721) token standards and takes cues from each in its structure, style, and semantics.
...
We chose Standard Interface Detection ([EIP-165](https://eips.fyi/165)) to expose the interfaces that a compliant smart contract supports.
