...
This proposal is a follow up on [EIP-4400](https://eips.fyi/4400) and [EIP-4907](https://eips.fyi/4907) and introduces additional upgrades for lending and borrowing which include: 
...
**Every compliant contract MUST implement the `IERC5501` interface. This extension is OPTIONAL for [EIP-721](https://eips.fyi/721) contracts.** 
...
* **[EIP-4400](https://eips.fyi/4400) and [EIP-4907](https://eips.fyi/4907)**
...
This standard is compatible with current [EIP-721](https://eips.fyi/721) by adding an extension function set. The new functions introduced are similar to existing functions in EIP-721 which guarantees easy adoption by developers and applications. This standard also shares similarities to [EIP-4907](https://eips.fyi/4907) considering user role and its expiry which means applications will be able to determine the user if either of the standards is used.
