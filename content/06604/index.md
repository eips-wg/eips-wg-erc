...
Abstract tokens can comply with existing standards like [ERC-20](https://eips.fyi/20), [ERC-721](https://eips.fyi/721), and [ERC-1155](https://eips.fyi/1155). The standard allows wallets and other applications to better handle *potential* tokens before any consensus-dependent events occur on-chain.
...
All abstract token contracts must support [ERC-165](https://eips.fyi/165) and include the Abstract Token interface ID in their supported interfaces.
