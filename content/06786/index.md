...
Every contract compliant with [ERC-6786](https://eips.fyi/6786) MUST implement the interface defined as follows:
...
For fetching creator on-chain data we will use [ERC-2981](https://eips.fyi/2981), but any other on-chain method of getting the creator address is accepted.
