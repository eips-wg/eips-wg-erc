...
This EIP standardizes a schema for NFTs metadata to add new field namespaces to the JSON schema for [EIP-721](https://eips.fyi/721) and [EIP-1155](https://eips.fyi/1155) NFTs.
...
The same security considerations as with [EIP-721](https://eips.fyi/721) apply related to using http gateways or IPFS for the tokenURI method.
