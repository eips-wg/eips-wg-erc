...
This ERC standardizes an interface for contract-layer consensus-agnostic verifiable cross-chain bridging, through which we can define a new global token inherited from [ERC-20](https://eips.fyi/20)/[ERC-721](https://eips.fyi/721) over multi-chains.  
...
- Every [ERC-6358](https://eips.fyi/6358) compliant contract MUST implement the `IERC6358`  
...
The ERC-6358 Token could be implemented with the [interfaces mentioned above](#smart-contract-interface). It can also be used with the combination of [ERC-20](https://eips.fyi/20)/[ERC-721](https://eips.fyi/721).  
