...
The Public On-Chain Non-Fungible Token Attributes Repository standard provides the ability for [ERC-721](https://eips.fyi/721) and [ERC-1155](https://eips.fyi/1155) compatible tokens to store their attributes on-chain available to any external smart contract interacting with them.
...
This ERC introduces new utilities for [ERC-721](https://eips.fyi/721) and [ERC-1155](https://eips.fyi/1155) based tokens in the following areas:
...
The Attributes repository standard is fully compatible with [ERC-721](https://eips.fyi/721) and [ERC-1155](https://eips.fyi/1155) and with the robust tooling available for implementations of ERC-721 as well as with the existing ERC-721 infrastructure.
