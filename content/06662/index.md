...
This ERC proposes a new **IAccountMetadata** interface as an extension for [ERC-4337](https://eips.fyi/4337) to store authentication data on-chain to support a more user-friendly authentication model.
