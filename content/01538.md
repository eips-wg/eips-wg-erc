...
Replaced by [EIP-2535 Diamond Standard](https://eips.fyi/2535).
...
<!--
A transparent contract must implement the [ERC-165 Standard Interface Detection standard](https://eips.fyi/165) via a delegate contract by adding the `supportsInterface` function using the `updateContract` function. The interfaceID for the ERC1538 standard is `0x61455567`.
-->
