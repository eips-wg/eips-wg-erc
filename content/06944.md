...
This EIP adds a new [ERC-4804](https://eips.fyi/4804) `resolveMode` to resolve [ERC-5219](https://eips.fyi/5219) contract resource requests.
...
[ERC-165](https://eips.fyi/165) was not used because interoperability can be checked by calling `resolveMode`.
...
The security considerations of [ERC-4804](https://eips.fyi/4804#security-considerations) and [ERC-5219](https://eips.fyi/5219#security-considerations) apply.
