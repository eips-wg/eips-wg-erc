...
representing shares of a single underlying [EIP-20](https://eips.fyi/20) token.
...
All [EIP-4626](https://eips.fyi/4626) tokenized Vaults MUST implement EIP-20 to represent shares.
...
EIP-4626 tokenized Vaults MAY implement [EIP-2612](https://eips.fyi/2612) to improve the UX of approving shares on various integrations.
