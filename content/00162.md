...
For more background, refer to [EIP-137](https://eips.fyi/137).
...
- [EIP-137](https://eips.fyi/137) outlines the initial implementation of the Registry Contract (ENS.sol) and associated Resolver contracts.
