...
Some implementations of [EIP-721](https://eips.fyi/721) and [EIP-1155](https://eips.fyi/1155)
...
1. Any contract complying with [EIP-20](https://eips.fyi/20) when extended with this EIP,
...
2. Any contract complying with [EIP-721](https://eips.fyi/721) when extended with this EIP,
**MUST** implement the following interface:
...
3. Any contract complying with [EIP-1155](https://eips.fyi/1155) when extended with this EIP,
**MUST** implement the following interface:
...
[EIP-721](https://eips.fyi/721) and [EIP-1155](https://eips.fyi/1155).

7. It's RECOMMENDED for the client to implement [EIP-165](https://eips.fyi/165) identifiers as specified above.
...
2. We have chosen to identify the interface with [EIP-165](https://eips.fyi/165) identifiers each individually,
...
5. We have not add extension for [EIP-777](https://eips.fyi/777) because it already handles Minting and Burning.
