...
This is a slimmed-down alternative to [EIP-173](https://eips.fyi/173).
...
Implementing [EIP-165](https://eips.fyi/165) could be a valuable addition to this interface specification. However, this EIP is being written to codify existing protocols that connect contracts (often NFTs), with third-party websites (often a well-known NFT marketplace).
