...
This standard requires [ERC-173](https://eips.fyi/173) and SHOULD implement the functions:
...
**`ERC725X`** interface id according to [ERC-165](https://eips.fyi/165): `0x7545acac`.

Smart contracts implementing the `ERC725X` standard MUST implement the [ERC-165](https://eips.fyi/165) `supportsInterface(..)` function and MUST support the `ERC165` and `ERC725X` interface ids.
...
> See [EIP-1014: Skinny CREATE2](https://eips.fyi/1014) for more information.
...
**`ERC725Y`** interface id according to [ERC-165](https://eips.fyi/165): `0x629aa694`.

Smart contracts implementing the `ERC725Y` standard MUST implement the [ERC-165](https://eips.fyi/165) `supportsInterface(..)` function and MUST support the `ERC165` and `ERC725Y` interface ids.
