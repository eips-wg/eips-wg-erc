...
This standard defines an interface for [ERC-721](https://eips.fyi/721) or [ERC-1155](https://eips.fyi/155) tokens, known as "bindables", to "bind" to [ERC-721](https://eips.fyi/721) NFTs.
...
In contrast with other standards that deal with token ownership at the account level, this standard aims to address token ownership at the NFT level. Its objective is to build a universal interface for token bundling, compatible with existing [ERC-721](https://eips.fyi/721) and [ERC-1155](https://eips.fyi/1155) standards.
