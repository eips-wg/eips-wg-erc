...
This standard is an extension of [ERC-721](https://eips.fyi/721). It proposes some additional functions (`startTime`, `endTime`) to help with on-chain time management.
