...
[ERC-3770](https://eips.fyi/3770) introduces a new address standard to be adapted by wallets and dApps to display chain-specific addresses by using a human-reacable prefix.
...
`address` is mandatory and MUST be a [ERC-55](https://eips.fyi/55) compatible hexadecimal address
