...
The **metadata updates extension** is OPTIONAL for [EIP-721](https://eips.fyi/721) and [EIP-1155](https://eips.fyi/1155) contracts.
...
The original metadata for a given NFT is always defined as the JSON pointed by the result of `tokenURI` for [EIP-721](https://eips.fyi/721) and function `uri` for [EIP-1155](https://eips.fyi/1155).
...
The proposal is fully compatible with both [EIP-721](https://eips.fyi/721) and [EIP-1155](https://eips.fyi/1155). Third-party applications that don't support this EIP will still be able to use the original metadata for each NFT.
