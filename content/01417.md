...
3. Allow the compatibility with token standard such as [ERC-20](https://eips.fyi/20) or (https://eips.fyi/777)) and membership standard such as [EIP-1261](https://eips.fyi/1261)
...
/// @dev See https://github.com/ethereum/EIPs/blob/master/EIPS/https://eips.fyi/1417
...
- [EIP-20: ERC-20 Token Standard (a.k.a. ERC-20)](https://eips.fyi/20)
- [EIP-165: Standard Interface Detection](https://eips.fyi/165)
- [EIP-721: Non-Fungible Token Standard(a.k.a. ERC-721)](https://eips.fyi/721)
- [ERC-1261 MV Token Standard](https://eips.fyi/1261)
