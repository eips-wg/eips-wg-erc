...
resolvers storing DNS resource records [EIP-1185](https://eips.fyi/1185), although the technique could be
used on other interfaces like IPFS content hash storage [EIP-1062](https://eips.fyi/1062).
...
ENS can respond to queries with IP addresses (as described in [EIP-1185](https://eips.fyi/1185))
...
In addition to geographic split horizon DNS, GeoENS can be used for the following:
 ...
 - ENS + IPFS web hosting (as described in [EIP-1062](https://eips.fyi/1062)) with content translated to the native language of the query source.
