...
* Game developers could share an [ERC-1155](https://eips.fyi/1155) contract where each developer manages tokens under a specified scope.
...
**Standards**
- [ERC-1155 Multi Token Standard](https://eips.fyi/1155)
