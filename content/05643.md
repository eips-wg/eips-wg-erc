...
This standard is an extension of [EIP-721](https://eips.fyi/721). It proposes an additional interface for NFTs to be used as recurring, expirable subscriptions. The interface includes functions to renew and cancel the subscription.
