...
This standard allows NFTs that support [ERC-721](https://eips.fyi/721) and [ERC-1155](https://eips.fyi/1155) interfaces, to have a standardized way of signalling royalty information. More specifically, these contracts can now calculate a royalty amount to provide to the rightful recipient.
