...
A set of functions to enable meta-transactions and atomic interactions with [ERC-20](https://eips.fyi/20) token contracts via signatures conforming to the [EIP-712](https://eips.fyi/712) typed message signing specification.
...
The arguments `v`, `r`, and `s` must be obtained using the [EIP-712](https://eips.fyi/712) typed message signing spec.
