...
A proposal for a tokenized reserve mechanism. The reserve allows an audit of on-chain actions of the owner. Using [ERC-4626](../EIPS/https://eips.fyi/4626), stakeholders can create shares to show support for actions in the reserve.
...
Tokenized reserves are made compatible with [ERC-20](../EIPS/https://eips.fyi/20) and [ERC-4626](../EIPS/https://eips.fyi/4626).
