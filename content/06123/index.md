...
The process logic of SDC can be implemented as a finite state machine on solidity. An [EIP-20](https://eips.fyi/20) token can be used for frictionless decentralized settlement, see reference implementation.
...
![image info](./assets/doc/sdc_trade_and_process_states.png)

### Sequence diagram of trade initiation and settlement livecycle

![image info](./assets/doc/sdc_livecycle_sequence_diagram.png)

## Test Cases

Live-cycle unit tests based on the sample implementation and usage of [EIP-20](https://eips.fyi/20) token is provided. See file [test/SDC.js](./assets/test/SDC.js)
).

## Reference Implementation

A reference implementation SDC.sol is provided and is based on the [EIP-20](https://eips.fyi/20) token standard. 
