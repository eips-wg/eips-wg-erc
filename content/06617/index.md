...
Currently permission and access control is performed using a single owner ([ERC-173](https://eips.fyi/173)) or with `bytes32` roles ([ERC-5982](https://eips.fyi/5982)).
