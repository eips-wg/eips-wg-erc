...
1. Any compliant contract MUST implement [EIP-721](https://eips.fyi/721), and [EIP-165](https://eips.fyi/165).
...
1. We only support [EIP-721](https://eips.fyi/721) NFTs for simplicity and gas efficiency. We have not considered other EIPs, which can be left for future extensions. For example, [EIP-20](https://eips.fyi/20) and [EIP-1155](https://eips.fyi/1155) were not considered.
