...
The signature is created using **[ERC-191](https://eips.fyi/191)**, signing the **`MigrateOpHash`** (calculated as **`abi.encode(chainID, selector, data)`**).
