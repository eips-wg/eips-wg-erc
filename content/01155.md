...
The optional `ERC1155Metadata_URI` extension can be identified with the [ERC-165 Standard Interface Detection](https://eips.fyi/165).
...
The function `setApprovalForAll` allows an operator to manage one's entire set of tokens on behalf of the approver. To permit approval of a subset of token IDs, an interface such as [ERC-1761 Scoped Approval Interface](https://eips.fyi/1761) is suggested.
...
- [ERC-165 Standard Interface Detection](https://eips.fyi/165)
- [ERC-1538 Transparent Contract Standard](https://eips.fyi/1538)
