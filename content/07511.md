...
With the `PUSH0` opcode ([EIP-3855](https://eips.fyi/3855)), introduced with the Shanghai upgrade, we optimized the previous Minimal Proxy Contract ([ERC-1167](https://eips.fyi/1167)) by 200 gas at deployment and 5 gas at runtime, while retaining the same functionality.
