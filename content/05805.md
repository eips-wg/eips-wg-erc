...
#### [ERC-6372](https://eips.fyi/6372): clock and CLOCK_MODE
...
This signature should follow the [EIP-712](https://eips.fyi/712) format:
...
where `DOMAIN_SEPARATOR` is defined according to [EIP-712](https://eips.fyi/712). The `DOMAIN_SEPARATOR` should be unique to the contract and chain to prevent replay attacks from other domains,
