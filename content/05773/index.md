...
2. **Why are [EIP-712](https://eips.fyi/712) permit-style signatures to manage approvals not used?**\
...
The MultiAsset token standard has been made compatible with [ERC-721](https://eips.fyi/721) in order to take advantage of the robust tooling available for implementations of ERC-721 and to ensure compatibility with existing ERC-721 infrastructure.
