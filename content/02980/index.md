...
description: An interface for asset tokens, compliant with Swiss Law and compatible with [ERC-20](https://eips.fyi/20).
...
The ERC-2980 extends [ERC-20](https://eips.fyi/20). Due to the indivisible nature of asset tokens, the decimals number MUST be zero.
