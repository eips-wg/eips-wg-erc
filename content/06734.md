...
<a name="r4"> **[R4]** </a>
The chainId property utilized MUST allow for the requirements of the [EIP-155](https://eips.fyi/155) standard to be met.
...
<a name="d2"> **[D2]** </a>
The `chainId` property SHOULD follow [EIP-3220](https://eips.fyi/3220) draft standard.

[[D2]](#d2) testability: The [EIP-3220](https://eips.fyi/3220) draft standard can be tested because the crosschain id is specified as a concatenation of well-defined strings, and using open source tooling can be used to parse and split a crosschain id, the obtained string segments can be compared against expected string lengths, and context dependent, the values for the strings specified in the standard. Consequently, [[D2]](#d2) is testable.
                 ...
                 "items": {
                    ...
                    "properties": {
                        ...
                        "standard": {
                            ...
                            "type": "string",
                            "examples": ["https://github.com/ethereum/EIPs/blob/master/EIPS/https://eips.fyi/20"]
                        },
                        "address": {
