...
1. Verify the binding relationship between data on-chain and off-chain data through signature based on [ERC-1271](https://eips.fyi/1271)
Through the signature method based on the [ERC-1271](https://eips.fyi/1271) protocol, the verifyIdentiesBinding function of this EIP realizes the binding of the userID and NFT owner address between on-chain and off-chain.
...
As mentioned in the specifications section, this standard can be fully [ERC-721](https://eips.fyi/721) compatible by adding an extension function set.
In addition, new functions introduced in this standard have many similarities with the existing functions in [ERC-721](https://eips.fyi/721). This allows developers to easily adopt the standard quickly.
