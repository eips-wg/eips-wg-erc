...
The following describes standard functions for an [ERC-721](https://eips.fyi/721) compatible contract with a total supply of one.
...
This change would enable automatically all the capabilities of composable tokens [ERC-998](https://eips.fyi/998) (own other ERC-721 or [ERC-20](https://eips.fyi/20)) natively without adding any extra code, just forbidding to mint more than one token per deployed contract.
