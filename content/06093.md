...
This EIP defines a standard set of custom errors for commonly-used tokens, which are defined as [ERC-20](https://eips.fyi/20), [ERC-721](https://eips.fyi/721), and [ERC-1155](https://eips.fyi/1155) tokens.
...
However, [ERC-20](https://eips.fyi/20), [ERC-721](https://eips.fyi/721), [ERC-1155](https://eips.fyi/1155) were already finalized when custom errors were released, so no errors are included in their specification.
