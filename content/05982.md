...
5. Compliant contracts SHOULD implement [ERC-165](https://eips.fyi/165) identifier.
...
2. The methods in `IERC_ACL_GENERAL` conform to [ERC-5750](https://eips.fyi/5750) to allow extension.
