...
- `assetTokenAddress` is the token ([ERC-20](https://eips.fyi/20), [ERC-721](https://eips.fyi/721), [ERC-1155](https://eips.fyi/1155)) smart contract address where the zero address MUST represents the Native coin (Native ETH in the case of Ethereum network).
